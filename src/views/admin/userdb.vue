...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">user관리</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
		...
		<div class="card">
            ...
            <option value="100">All</option>
					...
					<div class="datatable-container">
						...
						<thead>
						<tr>
              <th data-sortable="true" style="width: 8.827537260468414%;">
							...
							<th data-sortable="true" style="width: 9.155429382540808%;">
								<button class="datatable-sorter">nick</button>
							</th>
							<th data-sortable="true" style="width: 9.962384669978707%;">
								<button class="datatable-sorter">bphone</button>
							</th>
							<th data-format="YYYY/DD/MM" data-sortable="true" data-type="date" style="width: 9.962384669978707%;">
								<button class="datatable-sorter">baccount</button>
							</th>
              <th data-format="true" data-sortable="true" data-type="date" style="width: 11.155429382540808%;">
								<button class="datatable-sorter">baname</button>
							</th>
              <th data-format="YYYY/DD/MM" data-sortable="true" data-type="date" style="width: 9.962384669978707%;">
								<button class="datatable-sorter">bcode</button>
							</th>
              <th data-format="YYYY/DD/MM" data-sortable="true" data-type="date" style="width: 18.53087295954578%">
								<button class="datatable-sorter">bdate</button>
							</th>
						</tr>
						</thead>
						<tbody>
